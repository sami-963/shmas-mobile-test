...
import D_teacher from "./../../../components/profil/teachersprofil/dasbordteachers/D-teacher";

function Teachersprofil() {
    ...
    <div className="profil flex container">
      ...
      <div className="bacsidebae">
        <div className="sidebae flex">
          ...
          {/* اللوحة الرئيسية */}
          <div className="mainn">
            <D_teacher dashbordData={dashbordData} section={activeSection} />
          </div>
        </div>
      </div>
    </div>
