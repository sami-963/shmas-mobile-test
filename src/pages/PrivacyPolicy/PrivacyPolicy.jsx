...
function Terms() {
  const policyData = [
    ...
    { title: "ما هي ملفات تعريف الارتباط (Cookies)؟", description1: "ملفات تعريف الارتباط هي ملفات نصية صغيرة تُخزَّن داخل متصفحك وتساعد الموقع على العمل بطريقة صحيحة.", description2: "نستخدم ملفات الارتباط من الدرجة الأولى والثالثة لأغراض الوظائف، والإحصاءات، والإعلانات." },
